...
export default function ManagerScheduleEditor({ people, onMessage, onError }: { people: Person[]; onMessage: (value: string) => void; onError: (value: string) => void }) {
  ...
  async function loadEmployee() {
    ...
    const [{ data, error }, { data: rotationRows, error: rotationError }] = await Promise.all([
      supabase.rpc('manager_get_current_schedule', { p_employee_id: employeeId }),
  ...
  return <div className="stack">
    <div className="card">
      ...
      {selected && <form className="stack" style={{ marginTop: 16 }} onSubmit={saveSchedule} onKeyDown={preventEnterSubmit}>
    ...
    <div className="card">
      ...
      <form className="stack" style={{ marginTop: 16 }} onSubmit={saveRotation} onKeyDown={preventEnterSubmit}>
